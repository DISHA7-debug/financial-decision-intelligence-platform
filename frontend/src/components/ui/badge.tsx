...
const badgeVariants = cva(
  "inline-flex items-center rounded-md border px-6 py-3 text-[14px] font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2",
  {
    variants: {
      variant: {
